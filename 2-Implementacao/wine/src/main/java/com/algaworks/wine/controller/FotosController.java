...
//Facilita a escrita dos métodos para trabalhar com JSON.
//Quando retornar algum tipo de dado ele converte para JSON e o Javascript vai entender
@RestController
...
public class FotosController {
	...
	//Não é obrigatorio. Porque só vai ser usando quando o @Profile for "storage-local"
